...
const Checkout: React.FC<CheckoutProps> = ({ cartItems, totalPrice, onBack }) => {
  ...
  const handlePlaceOrder = async () => {
    ...
    try {
      ...
      const now = new Date();
      const dateTimeStamp = now.toLocaleString('en-US', {
        weekday: 'long',
        year: 'numeric',
        month: 'long',
        day: 'numeric',
...
${cartItems.map(item => {
        ...
        line += ` x${item.quantity} - $${(item.price * item.quantity).toLocaleString('en-US', { minimumFractionDigits: 0 })}`;
...
💰 PRICING
Product Total: $${totalPrice.toLocaleString('en-US', { minimumFractionDigits: 0 })}
Shipping Fee: $${shippingFee.toLocaleString('en-US', { minimumFractionDigits: 0 })} (${shippingLocation.replace('_', ' & ')})
${discountAmount > 0 ? `Discount (${appliedPromo?.code}): -$${discountAmount.toLocaleString('en-US', { minimumFractionDigits: 0 })}\n` : ''}Grand Total: $${finalTotal.toLocaleString('en-US', { minimumFractionDigits: 0 })}
                ...
                <div className="space-y-4 mb-6">
                  ...
                  {discountAmount > 0 ? (
                    <>
                      ...
                      <div className="flex justify-between items-center">
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <span className="font-semibold text-green-600">
                            ${(totalPrice - discountAmount).toLocaleString('en-US', { minimumFractionDigits: 0 })}
                          </span>
                        </div>
                      </div>
                      ...
                      <div className="flex justify-between items-center bg-green-50 -mx-6 px-6 py-3 rounded-lg border border-green-100">
                        ...
                        <span className="font-bold text-green-700">
                          -${discountAmount.toLocaleString('en-US', { minimumFractionDigits: 0 })}
                        </span>
                      </div>
                      ...
                      <div className="flex justify-center -mx-6 px-6 py-2 bg-gradient-to-r from-green-500 to-green-600 -mt-2">
                        <p className="text-white text-sm font-bold flex items-center gap-1.5">
                          ...
                          You saved ${discountAmount.toLocaleString('en-US', { minimumFractionDigits: 0 })}!
                        </p>
                      </div>
                    </>
                  ) : (
                    <div className="flex justify-between text-gray-600">
                      <span>Subtotal</span>
                      <span className="font-medium">${totalPrice.toLocaleString('en-US', { minimumFractionDigits: 0 })}</span>
                    </div>
                  )}
                  ...
                  <div className="flex justify-between text-gray-600 text-xs">
                    ...
                    <span className="font-medium text-gold-600">
                      {shippingLocation ? `$${shippingFee.toLocaleString('en-US', { minimumFractionDigits: 0 })}` : 'Select location'}
                    </span>
                  </div>
                  <div className="border-t-2 border-gray-200 pt-3">
                    <div className="flex justify-between items-center">
                      ...
                      <span className="text-2xl font-bold text-gold-600">
                        ${finalTotal.toLocaleString('en-US', { minimumFractionDigits: 0 })}
                      </span>
                    </div>
                    {!shippingLocation && (
              ...
              {paymentMethodInfo && (
                <div className="bg-gold-50 rounded-lg p-6 border border-navy-600">
                  ...
                  <div className="space-y-2 text-sm text-gray-700 mb-4">
                    ...
                    <p><strong>Amount to Pay:</strong> <span className="text-xl font-bold text-gold-600">${finalTotal.toLocaleString('en-US', { minimumFractionDigits: 0 })}</span></p>
                  </div>
            ...
            <div className="bg-white rounded-2xl shadow-xl p-5 md:p-6 sticky top-24 border-2 border-navy-700/30">
              ...
              <div className="space-y-3">
                ...
                <div className="flex justify-between text-gray-600 text-xs">
                  <span>Shipping</span>
                  <span className="font-medium text-gold-600">
                    {shippingLocation ? `$${shippingFee.toLocaleString('en-US', { minimumFractionDigits: 0 })} (${shippingLocation.replace('_', ' & ')})` : 'Select location'}
                  </span>
                </div>
                <div className="border-t-2 border-gray-200 pt-3">
                  <div className="flex justify-between items-center">
