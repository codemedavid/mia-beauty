...
const VariationManager: React.FC<VariationManagerProps> = ({ product, onClose }) => {
  // Use includeAll: true to match AdminDashboard and get fresh variation data
  const { products, addVariation, updateVariation, deleteVariation } = useMenu({ includeAll: true });

  // Get the latest product data from the hook instead of using stale props
        ...
        <div className="bg-gradient-to-r from-teal-500 to-emerald-600 text-white p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-teal-100 mt-1">Product: {currentProduct.name}</p>
          ...
          <div className="mb-6">
            <h3 className="text-lg font-bold text-gray-900 mb-4 flex items-center gap-2">
              ...
              <span className="text-sm font-normal text-gray-500">
                ({currentProduct.variations?.length || 0} variations)
              </span>
            </h3>
