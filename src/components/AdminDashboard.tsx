...
const AdminDashboard: React.FC = () => {
  ...
  // Use includeAll: true to fetch ALL products (including unavailable) for admin management
  const { products, loading, addProduct, updateProduct, deleteProduct, refreshProducts } = useMenu({ includeAll: true });
                    ...
                    <div className="flex items-center gap-3">
                      <div>
                        ...
                        <div className="text-sm font-bold text-gray-900">
                          ${product.base_price.toLocaleString('en-US', { minimumFractionDigits: 0, maximumFractionDigits: 0 })}
                        </div>
                      </div>
                      <div>
